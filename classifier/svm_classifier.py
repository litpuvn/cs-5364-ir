...
df_train = pd.read_csv("../aid_request/no_train_hw4.csv", sep="|")

df_test = pd.read_csv("../aid_request/no_test_hw4.csv", sep="|")
...
# df_test.to_csv("../aid_request/no_processed_count_vector_predicted.csv", sep="|", quotechar='"', index=False)
